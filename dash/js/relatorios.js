document
  ...
  .addEventListener("click", () =>
    alert("A exportação do relatório será disponibilizada na próxima etapa."),
  );
new Chart(document.querySelector("#monthlyChart"), {
  ...
  data: {
    ...
    datasets: [
      {
        label: "Criados",
        data: [26, 39, 34, 48, 44, 57],
        backgroundColor: "#a5b4fc",
        borderRadius: 5,
      },
      {
        label: "Concluídos",
        data: [18, 28, 29, 40, 38, 46],
...
new Chart(document.querySelector("#reportStatusChart"), {
  type: "doughnut",
  data: {
