...
document.documentElement.dataset.theme =
  savedPreferences.theme === "system" || !savedPreferences.theme
    ? window.matchMedia("(prefers-color-scheme: dark)").matches
      ? "dark"
      : "light"
    : savedPreferences.theme;
document.documentElement.dataset.sidebar =
  savedPreferences.sidebar || "expanded";
if (savedPreferences.primaryColor)
  document.documentElement.style.setProperty(
    "--primary",
    savedPreferences.primaryColor,
  );
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .querySelectorAll('.sidebar-footer .menu-item[href="#"]')
    .forEach((link) => {
