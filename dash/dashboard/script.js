...
const processosAndamento =
    document.getElementById("processosAndamento");

const processosConcluidos =
    document.getElementById("processosConcluidos");

const processosPendentes =
    document.getElementById("processosPendentes");

const tabela =
    document.getElementById("processosTable");
...
const setorFilter =
    document.getElementById("setorFilter");
...
let notificacoes = [

    {
        ...
        mensagem:
            "O processo 2026/001245 foi encaminhado para o setor GRH.",
...

    {
        ...
        mensagem:
            "O processo 2026/001198 foi concluído com sucesso.",
...

    {
        ...
        mensagem:
            "O processo 2026/001176 está aguardando uma ação.",
...

    {
        ...
        mensagem:
            "O processo 2026/001054 recebeu prioridade alta.",
